    ...
    >
      <div className="p-6 border-b border-white/20 flex justify-between items-start">
        ...
        <button
          ...
          className="p-2 rounded-full transition-all duration-200 text-indigo-200 hover:bg-white/20 hover:text-white flex-shrink-0"
          title="Abréviations"
          aria-label="Ouvrir la liste des abréviations"
        >
